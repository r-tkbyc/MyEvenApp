...
interface PromptTheme {
     ...
     * @param context - Additional context for rendering the help message.
     */
    renderHelp(type: 'inline', item: RawItem, context: Partial<RenderHelpContext>): string;
    /**
...
export type { Item, ItemTypeUnion, Keybinds, PromptConfig, PromptTheme, RawItem, RenderHelpContext, RenderItemContext, StatusType };
